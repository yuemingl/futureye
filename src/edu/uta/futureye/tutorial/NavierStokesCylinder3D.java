 ...
 *
 */
public class NavierStokesCylinder3D {
	...
	//viscosity
	protected double mu = 0.001; //0.0005
...
//		}
		...
		mapNTF_u.put(NodeType.Dirichlet, new AbstractFunction("x","y","z") {
			@Override
		...
		mapNTF_p.put(NodeType.Dirichlet, new AbstractFunction("x","y","z") {
			@Override
			public double value(Variable v) {
				double x = v.get("x");
				//right side p=0
...
//			eList.at(i).printDOFInfo();
	...
	public static void main(String[] args) {
		NavierStokesCylinder3D NS = new NavierStokesCylinder3D();
		int testCaseNo = 3;
