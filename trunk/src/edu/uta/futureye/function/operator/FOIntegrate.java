...
public class FOIntegrate{
	 ...
	 * @return Function
	 */	
	public static double intOnTriangleRefElement(Function integrand, int order) {
		double rlt = 0.0;
		if(order == 2) {
	 ...
	 * @return
	 */
	public static double intOnLinearRefElement(Function integrand, int order) {
		double a1_1 = 0.0;
		double h1_1 = 2.0;
	 ...
	 * @return
	 */
	public static double intOnRectangleRefElement(Function integrand, int order) {
		double a1_1 = 0.0;
		double h1_1 = 4.0;
...
//			}
	 ...
	 * @return
	 */
	public static double intOnTetrahedraRefElement(Function integrand, int order) {
		double a1_1 = 0.25;
		double h1_1 = 1;
	...
	public static double intOnHexahedraRefElement(Function integrand, int order) {
		Variable v = new Variable();
		VariableArray valAry = new VariableArray();
		double rlt = 0.0;
		if(order == 2) {
