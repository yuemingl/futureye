...
public class MouseHead {
	...
	public Function mu_aSimulate = null;
	 ...
	 * @param bkMu_a
	 */
	public Function makeBandMu_a(double incX, double incBand, double maxMu_a, double bkMu_a) {
	 ...
	 * @return
	 */
	public Function makeMu_a(double incX, double incY, double incR, double maxMu_a, double bkMu_a) {
		Function rltMu_a = null;
		final double fcx = incX;
